    ...
    <>
        ...
        <div style={{position:"fixed", height:"120px", backgroundColor:"#181818", border:"solid #181818", width:"100%", top:"0%"}}>
            <Flexbox flexDirection='row' justifyContent='space-between' style={{marginTop:"20px"}}>
                <Flexbox flexDirection='row'>
                    <img src={logo} height="100px" width="100px" style={{marginLeft:"1cm"}} onClick={(event) => {setSearchValue("")}}/>
                    <div style={{marginTop:"0.6cm"}}>
                        <style>
                            @import url('https://fonts.googleapis.com/css2?family=Open+Sans:wght@400&display=swap');
                        </style>
                        <Flexbox flexDirection='row'>
                            <p style={{color:(movieSelect ? "white" : "#747474"), marginLeft:"1cm"}} onMouseOver={() => {setMovieSelect(true)}} onMouseOut={() => {setMovieSelect(false)}}>Movies</p>
                            <p style={{color:(serieSelect ? "white" : "#747474"), marginLeft:"0.5cm"}} onMouseOver={() => {setSerieSelect(true)}} onMouseOut={() => {setSerieSelect(false)}}>Series</p>
                        </Flexbox>
                    </div>
                </Flexbox>
